...
public class Config {
	...
	public static final PluginConfigKey CLAIM_MAX_NORMAL		= new PluginConfigKey("claim.max.normal",		25);
	public static final PluginConfigKey CLAIM_MAX_PREMIUM		= new PluginConfigKey("claim.max.normal",		50);
	public static final PluginConfigKey CLAIM_MAX_INVESTOR		= new PluginConfigKey("claim.max.normal",		40);
	public static final PluginConfigKey CLAIM_MAX_BUILDER		= new PluginConfigKey("claim.max.normal",		35);
	public static final PluginConfigKey CLAIM_MAX_VIP			= new PluginConfigKey("claim.max.normal",		30);
